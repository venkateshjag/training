...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1500408578);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1500408818);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1500408698);
...
user_pref("browser.safebrowsing.provider.google.lastupdatetime", "1500408762641");
user_pref("browser.safebrowsing.provider.google.nextupdatetime", "1500410661641");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1500408466490");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1500412066490");
user_pref("browser.search.countryCode", "US");
user_pref("browser.search.region", "US");
user_pref("browser.slowStartup.averageTime", 13557);
...
user_pref("browser.urlbar.lastSuggestionsPromptDate", 20170718);
user_pref("datareporting.policy.dataSubmissionPolicyAcceptedVersion", 2);
user_pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", "1500408524082");
user_pref("datareporting.sessions.current.activeTicks", 21);
user_pref("datareporting.sessions.current.clean", true);
user_pref("datareporting.sessions.current.firstPaint", 13979);
user_pref("datareporting.sessions.current.main", 1686);
user_pref("datareporting.sessions.current.sessionRestored", 13672);
user_pref("datareporting.sessions.current.startTime", "1500408450234");
user_pref("datareporting.sessions.current.totalTime", 432);
...
user_pref("media.gmp-gmpopenh264.lastUpdate", 1500408529);
user_pref("media.gmp-gmpopenh264.version", "1.6");
user_pref("media.gmp-manager.buildID", "20170201180315");
user_pref("media.gmp-manager.lastCheck", 1500408529);
...
user_pref("toolkit.startup.last_success", 1500408451);
